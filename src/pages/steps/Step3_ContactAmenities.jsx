        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-1.5">
            <input
              ...
              className="px-2 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent hover:border-gray-400 transition-all duration-200"
            />
            <button
              type="button"
              onClick={handleAmenityAdd}
              className="px-3 py-2 bg-gradient-to-r from-cyan-500 to-cyan-600 focus:invisible hover:from-cyan-600 hover:to-cyan-700 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-200 flex items-center cursor-pointer"
            >
              Add
            </button>
          </div>
