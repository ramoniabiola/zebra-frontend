  ...
  return (
    <div className="space-y-8">
        <div className="text-center mb-8">
          <h2 className="text-xl lg:text-2xl font-bold text-gray-800 mb-0.5">Pricing & Duration</h2>
          <p className="text-gray-600 text-sm lg:text-base">Set your rental terms</p>
        </div>
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        placeholder="0"
                        className={`w-full pl-8 pr-4 py-3 border text-sm lg:text-base rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-200 ${
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        placeholder="0"
                        className="w-full pl-8 pr-4 py-3 border text-sm lg:text-base border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent hover:border-gray-400 transition-all duration-200"
                    />
                </div>
            </div>
        </div>
