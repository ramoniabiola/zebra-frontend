        ...
        <div className="max-w-4xl h-full flex flex-col items-start justify-start mx-auto"> 
            <div className="w-full h-full flex flex-col items-start justify-center gap-4 mb-8">
                ...
                <div className="w-full h-16 flex items-center justify-start gap-4 pl-2 pt-4 bg-white">
                    ...
                    <h1 className="font-bold text-gray-900 text-3xl">How It Works</h1>
                </div>
                ...
                <div className="w-full px-4 space-y-6 mt-8">
                    ...
                    <div className="border-b border-gray-200 pb-6">
                        <div className="flex items-start gap-4 mb-2">
                            <div className="w-12 h-12  bg-gradient-to-b from-cyan-50 to-cyan-100 border-2 border-cyan-200 rounded-full flex items-center justify-center text-cyan-600 font-bold text-lg shadow-lg">
                                1
                            </div>
                            <h3 className="text-xl font-semibold text-gray-900 mt-2">Browse Available Apartments</h3>
                        </div>
                    ...
                    <div className="border-b border-gray-200 pb-6">
                        <div className="flex items-start gap-4 mb-2">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mt-2">View Detailed Information</h3>
                        </div>
                        <p className="text-gray-600 leading-relaxed ml-16">
                    ...
                    <div className="border-b border-gray-200 pb-6">
                        <div className="flex items-start gap-4 mb-2">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mt-2">Contact Directly</h3>
                        </div>
                        <p className="text-gray-600 leading-relaxed ml-16">
                    ...
                    <div className="border-b border-gray-200 pb-6">
                        <div className="flex items-start gap-4 mb-2">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mt-2">Schedule & Secure</h3>
                        </div>
                        <p className="text-gray-600 leading-relaxed ml-16">
                ...
                {/* USER TYPES */}
                <div className="w-full px-4 space-y-6 mt-12">
                    <h2 className="text-2xl font-bold text-gray-900 text-center mb-6">Who Can Use Our Platform?</h2>
                    <div className="space-y-8">
                        {/* Landlords & Agents */}
                        <div className="p-2">
                            <div className="flex items-center gap-4 mb-4">
                                <div className="w-14 h-14 bg-gradient-to-br from-green-100 to-emerald-300 border-2 border-emerald-200  rounded-full flex items-center justify-center shadow-lg">
                                   <Home className="w-7 h-7 text-emerald-600" />
                                </div>
                                <h3 className="text-xl font-semibold text-gray-900">For Landlords & Agencies</h3>
                            </div>
                        ...
                        <div className="p-2">
                            <div className="flex items-center gap-4 mb-4">
                                <div className="w-14 h-14 bg-gradient-to-br from-orange-100 to-amber-300 border-2 border-orange-200 rounded-full flex items-center justify-center text-white text-2xl shadow-lg">
                                    <Search className="w-7 h-7 text-amber-600" />
                                </div>
                                <h3 className="text-xl font-semibold text-gray-900">For House Hunters</h3>
                            </div>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div className="text-center">
                                <div className="w-14 h-14 bg-gradient-to-br from-red-100 to-rose-300 border-2 border-rose-200  rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                            ...
                            {/* Budget-Friendly */}
                            <div className="text-center">
                                <div className="w-14 h-14 bg-gradient-to-br from-purple-100 to-violet-300 border-2 border-violet-200 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                                   <BadgeDollarSign className="w-6 h-6 text-violet-600" />
                                </div>
                            ...
                            {/* Location-Based */}
                            <div className="text-center">
                                <div className="w-14 h-14 bg-gradient-to-br from-green-100 to-teal-300 border-2 border-teal-200 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                                    <MapPinHouse className="w-6 h-6 text-teal-600"  />
                                </div>
                            ...
                            {/* Easy Access */}
                            <div className="text-center">
                                <div className="w-14 h-14 bg-gradient-to-br from-blue-100 to-sky-300 border-2 border-sky-200 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
