        ...
        {!submitted ? (
            <form onSubmit={handleSubmit} className="w-full max-w-xl p-6 rounded-md shadow-sm space-y-8">
                ...
                <div>
                    ...
                    <select
                        className="w-full border border-gray-200 rounded-md p-3 cursor-pointer outline-none" 
                        value={reason}
                ...
                <button
                    type="submit"
                    className="w-full bg-linear-65 from-cyan-400 to-cyan-600 text-white font-semibold py-3.5 rounded-md cursor-pointer"
                >
                Submit Report
            </button>
            </form>
