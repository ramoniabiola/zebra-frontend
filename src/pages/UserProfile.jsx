  ...
  import { AlertCircle, AlertTriangle, ArrowLeft, CheckCircle, Key, Loader2, LogOut, LogOutIcon, X, MoreVertical, Settings } from 'lucide-react';
            ...
            <div className="w-11/12 mx-auto mt-8 p-6 bg-white border-1 border-stone-100 rounded-xl shadow-sm">
              ...
              <div className="flex flex-col items-center justify-items-center mb-6">
                <div className="relative w-28 h-28 mb-4">
                  ...
                  {/* Photo change mode */}
                  {editMode && (
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center rounded-full cursor-pointer group">
