...
const Navbar = () => {
  ...
  return (
    <nav className="w-full h-12 lg:h-18 flex items-center justify-between bg-white px-6 lg:border-b lg:border-gray-200 md:px-12 lg:px-20 fixed top-0 left-0 z-50">
      {/* LOGO */}
      <Link to="/home">
          <h1 
